import type { AiWorkbenchSnapshot } from "./aiWorkbench";

export const AI_WORKBENCH_MOCK_SNAPSHOT: AiWorkbenchSnapshot = {
  schemaVersion: 1,
  ...
  projects: [
    {
      id: "codex:F:\\Download\\GitHub\\YiboVibe",
      providerId: "codex",
      name: "YiboVibe",
  ...
  conversations: [
    {
      id: "thread-1",
      providerId: "codex",
      projectId: "codex:F:\\Download\\GitHub\\YiboVibe",
      title: "收到回复 hello",
